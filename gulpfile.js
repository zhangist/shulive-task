...
const PATH = {
  ...
  FONT_SRC: `${SRC_PATH}/font/**/*`,
  FONT_DEST: `${DEST_PATH}/font`,
  VIEWS_SRC: './src/views/**/*',
...
// font
gulp.task('cleanfont', () => {
  gulp.src(`${PATH.FONT_DEST}/*`).pipe(clean());
});
gulp.task('font', ['cleanfont'], () => {
  gulp.src(PATH.FONT_SRC).pipe(gulp.dest(PATH.FONT_DEST));
});
...
gulp.task('default', ['img', 'css', 'vendors', 'js', 'view']);
